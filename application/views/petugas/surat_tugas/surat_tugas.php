      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="pull-right">
            <ul>
              <a class="btn btn-primary" href="<?php echo base_url('petugas/surat_tugas/surat_tugas/tambah_surat') ?>">
                      ...
                      <tbody>
                        ...
                        if (isset($surattugas)) {
                          foreach ($surattugas as $row) {
                            ...
                            <a href="<?=site_url('petugas/surat_tugas/surat_tugas/edit_surat/'. $row->noSuratTugas)?>" class="btn btn-success btn-sm" data-tooltip="tooltip" title="Edit" id="editSur" ><i class="fa fa-edit"></i></a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" id=hapusData>
          <form role="form" method="post" action="<?= base_url('petugas/surat_tugas/surat_tugas/hapus_surat') ?>">
            <div class="box-body">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" id=panelSur>
          <form role="form" method="post" action="<?= base_url('petugas/surat_tugas/surat_tugas/print') ?>">
            <div class="box-body">
