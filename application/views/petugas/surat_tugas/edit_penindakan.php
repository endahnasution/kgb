...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <form role="form" action="<?php echo base_url('petugas/surat_tugas/surat_tugas/ubah_surat_penindakan') ?>" method="post">
           ...
           <!--  <div class="form-group row">
              ...
              <div class="col-sm-12">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Nomor Surat Tugas" name="substansi" id="substansi" value="<?=$subs?>" disabled>
                </div>
              </div>
            </div> -->
