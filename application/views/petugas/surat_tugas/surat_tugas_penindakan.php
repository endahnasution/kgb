<section class="content-header">
    <h1>
        Menu Surat Tugas Penindakan
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Surat Tugas Penindakan</a></li>
    </ol>
</section>
<!-- Main content -->
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">Buat Surat Tugas Penindakan</h3>
                    <div class="pull-right">
                        <ul>
                            <a class="btn btn-primary" href="<?php echo base_url('petugas/surat_tugas/surat_tugas/tambah_surat_penindakan') ?>">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($surattugas)) {
                                                    foreach ($surattugas as $row) {
                                                        ...
                                                        <a href="<?= site_url('petugas/surat_tugas/surat_tugas/edit_surat_penindakan/' . $row->noSuratTugas) ?>" class="btn btn-success btn-sm" data-tooltip="tooltip" title="Edit" id="editSur"><i class="fa fa-edit"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id=editData>
                    <form action="<?= base_url('petugas/surat_tugas/surat_tugas/ubah_surat') ?>" method="post">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="jabatanPenandatangan" id="jabatanPenandatangan">
                                        ...
                                        <option>PLH Kepala Balai POM di Batam Koordinator Substansi Pengujian</option>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id=hapusData>
                    <form role="form" method="post" action="<?= base_url('petugas/surat_tugas/surat_tugas/hapus_surat_penindakan') ?>">
                        <div class="box-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id=panelSur>
                    <form role="form" method="post" action="<?= base_url('petugas/surat_tugas/surat_tugas/print_penindakan') ?>">
                        <div class="box-body">
