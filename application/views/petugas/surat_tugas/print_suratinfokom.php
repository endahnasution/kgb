		...
		<table style="width:100%">
			...
			<span style="font-size:12pt;">
				...
				<tr>
					...
					<td valign="top" style="width:80%">
						<p style="font-family:bookman old style;text-align:justify"> Peraturan Pemerintah Republik Indonesia No. 72 Tahun 1998 tentang Penanganan Sediaan Farmasi dan Alat Kesehatan;</p>
					</td>
				</tr>
		...
		<table style="width:100%">
			...
			<span style="font-size:12pt;">
				...
				<tr>
					...
					<td valign="top" style="width:80%">
						<p style="font-family:bookman old style;text-align:justify">Biaya<u class="hilang">iiiiiiiiiiiii</u>: DIPA Balai Pengawas Obat dan Makanan di Batam Tahun Anggaran 2022</p>
					</td>
				</tr>
