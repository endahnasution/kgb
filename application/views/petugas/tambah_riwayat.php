...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <form role="form" action="<?php echo base_url('petugas/Monitoring/simpan_riwayat') ?>" method="post">
                  ...
                  <div class="col-sm-12">
                    <div class="input-group">
                      ...
                      <select name="status" id="status" class="form-control category" data-live-search="true" required>
                        ...
                        <option selected="selected">- Status Monitoring -</option>
    ...
    <label class="form-check-label" for="exampleCheck1">Kesesuaian TL dengan pola TL</label>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="justifikasi" name="justifikasi" rows="3"></textarea>
            </div>
