	...
	<div class="page">
		...
		<?php echo $pasalPeringatan; ?>
			...
			<ol>
				...
				<li>
					<p style="font-family:arial;" class="paragraf">Melaporkan hasil tindak lanjut dan CAPA tersebut paling lambat 21 (dua puluh satu) hari kerja sejak tanggal surat tindak lanjut sarana dengan disertai data/dokumen pendukung yang ditujukan kepada Kepala Balai POM di Batam 
					</p>
				</li>
				<li>
