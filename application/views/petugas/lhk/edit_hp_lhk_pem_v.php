...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-12">
      <form action="<?php echo base_url('petugas/lhk/list_lhk_c/edit_hasilpem') ?>" method="post" role="form">
          ...
          <div class="box-header with-border">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-12">
                 <select class="form-control category" name="tl" id="tl" style="width: 100%;">

                    <?php

                    // foreach($temuan as $tm){
                    //   if($tm == $lhk->temuan){
                    if($tl=="TindakLanjutHasilPemeriksaan"){
                        $tl_display = "Tindak Lanjut Hasil Pemeriksaan";
                    }else if($tl=="PembinaanTeknis"){
                        $tl_display = "Pembinaan Teknis";
                    }else if($tl=="PeringatanKeras"){
                        $tl_display = "Peringatan Keras";
                    }else if($tl=="PenghentianSementaraKegiatan"){
                        $tl_display = "Penghentian Sementara Kegiatan";
                    }else if($tl=="RekomendasiPencabutanIzin"){
                        $tl_display = "Rekomendasi Pencabutan Izin";
                    }else if($tl=="TLkePenyidikan"){
                        $tl_display = "TL ke Penyidikan";
                    }else if($tl=="RekomendasiHasilPeringatan"){
                        $tl_display = "Rekomendasi Hasil Peringatan";
                    }else{
                         $tl_display =$tl;
                    }
                    echo "<option selected='selected' value=" . $tl . ">" . $tl_display . "</option>";
                    //   }else{
                    ...
                    <option value="TindakLanjutHasilPemeriksaan">Tindak Lanjut Hasil Pemeriksaan</option>
                    <option value="PembinaanTeknis">Pembinaan Teknis</option>
                    <option value="Peringatan">Peringatan</option>
                    <option value="PeringatanKeras">Peringatan Keras</option>
                    <option value="PenghentianSementaraKegiatan">PSK</option>
                    <option value="RekomendasiPencabutanIzin">Rekomendasi Pencabutan Izin</option>
                    <option value="TLkePenyidikan">TL ke Penyidikan</option>
                    <option value="RekomendasiHasilPeringatan">Rekomendasi Hasil Peringatan</option>
            ...
            <div class="col-md-6">
              <div class="form-group row">
                <label for="noSurat" class="col-sm-6 col-form-label">Tanggal Pemeriksaan<span class="wajib"> *</span></label>
              
                <div class="col-sm-12">
                <input class="form-control <?php echo form_error('tglLhk') ? 'is-invalid' : '' ?>" type="date" name="tanggal"  value="<?= $tanggal; ?>"   id="tanggal">
