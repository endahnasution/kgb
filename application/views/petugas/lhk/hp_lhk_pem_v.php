...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-12">
      <form action="<?php echo base_url('petugas/lhk/lhk_pem_c/hplhk') ?>" method="post" role="form">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Form Tambah Hasil Pemeriksaan LHK</h3>
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-12">
                <input class="form-control <?php echo form_error('tglLhk') ? 'is-invalid' : '' ?>" type="date" name="tanggal"  id="tanggal">
