...
<body onload="window.print()">
	...
	<div class="Section2">
		...
		?>
					...
					<table style="width:100%; font-family:arial;">
						...
						<tr>
							...
							<td>
								<p style="font-size: 11pt; font-family:Arial, Helvetica, sans-serif; text-align:justify"><?php 
								
								  if($tl[$nomor]=="TindakLanjutHasilPemeriksaan"){
                        $tl_display = "Tindak Lanjut Hasil Pemeriksaan";
                    }else if($tl[$nomor]=="PembinaanTeknis"){
                        $tl_display = "Pembinaan Teknis";
                    }else if($tl[$nomor]=="PeringatanKeras"){
                        $tl_display = "Peringatan Keras";
                    }else if($tl[$nomor]=="PenghentianSementaraKegiatan"){
                        $tl_display = "Penghentian Sementara Kegiatan";
                    }else if($tl[$nomor]=="RekomendasiPencabutanIzin"){
                        $tl_display = "Rekomendasi Pencabutan Izin";
                    }else if($tl[$nomor]=="TLkePenyidikan"){
                        $tl_display = "TL ke Penyidikan";
                    }else if($tl[$nomor]=="RekomendasiHasilPeringatan"){
		...
		<table style="width:100%; font-family:arial;">
			...
			<tr>
				<td>
					<p style="font-size: 11pt; font-family:Arial, Helvetica, sans-serif; text-align:justify"><u><?php echo $namaKetua; ?></u></p>
				</td>
				<td>
					<p><u></u></p>
				</td>
			...
			<tr>
				<td>
					<p style="font-size: 11pt; font-family:Arial, Helvetica, sans-serif; text-align:justify">NIP. <?php echo $nipKetua; ?></p>
				</td>
				<td>
					<p></p>
				</td>
