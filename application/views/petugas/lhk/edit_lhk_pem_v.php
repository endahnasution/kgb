              ...
              <label for="noSurat" class="col-sm-6 col-form-label">Ketua Tim<span class="wajib"> *</span></label>
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control " name="ketuaTim" id="ketuaTim" style="width: 100%;">
                                            <?php
                                            foreach ($ketuaTims as $ketuaTim) {
                                                if($ketuaTim->idPegawai == $idKetua){
                                                    echo "<option selected='selected' value=" . $ketuaTim->idPegawai . ">" . $ketuaTim->nama . "</option>";
                                                }
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12">
                          <a href="<?= site_url('petugas/lhk/list_lhk_c/hp_lhk/' . $row->idLhk) ?>" class="btn btn-primary btn-sm" data-tooltip="tooltip" title="Tambah Hasil Pemeriksaan" id="hplhk"> <i class="fa fa-plus">Tambah Hasil Pemeriksaan Sarana</i></a>
                          <p></p>
                                ...
                                <tbody>
                                  ...
                                  if ($sarana[0] != null) {
                                    ...
                                    foreach ($sarana as $row) {
                                      ...
                                      <a href="<?= site_url('petugas/lhk/list_lhk_c/edit_hp_lhk/' . $lhk[0]->idLhk . " " . $idSarana[$id]) ?>" class="btn btn-success btn-sm" data-tooltip="tooltip" title="Edit" id="ubahPj"> <i class="fa fa-edit"></i></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" id="hapusData">
        <form role="form" method="post" action="<?= base_url('petugas/lhk/lhk_pem_c/hapusHasilPemeriksaan') ?>">
          <div class="box-body">
