            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div class="pull-right">
                        <ul>
                            <a class="btn btn-primary" href="<?php echo base_url('petugas/lhkTu/list_lhk_c/tambahLhk') ?>">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($list_lhk)) {
                                                foreach ($list_lhk->result() as $row) {
                                                    ...
                                                    <a href="<?= site_url('petugas/lhkTu/list_lhk_c/edit_lhk/' . $row->idLhk) ?>" class="btn btn-primary btn-sm" data-tooltip="tooltip" title="Edit" id="ubahPj"> <i class="fa fa-edit"></i></a>
