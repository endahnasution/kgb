...
header("Content-Disposition: attachment; Filename=lhkTu-" . $filename)
    ...
    <div class="Section2">
        ...
        <table style="width:100%">
            ...
            <tr>
                ...
                <td>
                    <p class="satu" style="font-size: 11pt; font-family:Arial, Helvetica, sans-serif "><b>DASAR KEGIATAN :</b>
            ...
            <tr>
                ...
                <td>
                    <p class="satu" style="font-size: 11pt; font-family:Arial, Helvetica, sans-serif; text-align:justify"><b>TUJUAN KEGIATAN :</b>
            ...
            <td>
                <p class="satu" style="font-size: 11pt; font-family:Arial, Helvetica, sans-serif; text-align:justify"><b>YANG MELAKSANAKAN KEGIATAN :</b>
        ...
        <table style="width:100%">
            ...
            <tr>
                <td>
                    <p style="font-size: 11pt; font-family:Arial, Helvetica, sans-serif; text-align:justify"><u>Larasty Setyaningtyas,S.Farm.,Apt.</u></p>
                </td>
                <td>
                    <p><u></u></p>
                </td>
            ...
            <tr>
                <td>
                    <p style="font-size: 11pt; font-family:Arial, Helvetica, sans-serif; text-align:justify">NIP. 19840502200812 2 002</p>
                </td>
                <td>
                    <p></p>
                </td>
        ...
        <table style="width:90%">
            ...
            <tr>
                <p align="center" style="font-size: 11pt; font-family:Arial, Helvetica, sans-serif ">NIP. 19691222200012 1 001</p>
            </tr>
        </table>
