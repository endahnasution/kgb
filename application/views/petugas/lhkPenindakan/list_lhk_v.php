            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div class="pull-right">
                        <ul>
                            <a class="btn btn-primary" href="<?php echo base_url('petugas/lhkPenindakan/list_lhk_c/tambahLhk') ?>">
                                <i class="fa fa-plus"></i>&nbsp; Tambah Data
                            </a> </span>
                        </ul>
                    </div>
                    <h3 class="box-title"><i class="fa fa-list"></i> Daftar LHK Substansi Penindakan
                    </h3>
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($list_lhk)) {
                                                foreach ($list_lhk->result() as $row) {
                                                    ...
                                                    <a href="<?= site_url('petugas/lhkPenindakan/list_lhk_c/edit_lhk/' . $row->idLhk) ?>" class="btn btn-primary btn-sm" data-tooltip="tooltip" title="Edit" id="ubahPj"> <i class="fa fa-edit"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="hapusData">
                    <form role="form" method="post" action="<?= base_url('petugas/lhkPenindakan/list_lhk_c/hapus_lhk') ?>">
                        <div class="box-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id=panelSur>
                    <form role="form" method="post" action="<?= base_url('petugas/lhkPenindakan/list_lhk_c/print_lhk') ?>">
                        <div class="box-body">
