...
header("Content-Disposition: attachment; Filename=lhkPengujian-" . $filename)
...
$tglLhk2 = strtotime($tglLhk);
    ...
    <div class="Section2">
        ...
        <table style="width:100%">
            ...
            <tr>
                <td>
                    <p style="font-size: 11pt; font-family:Arial, Helvetica, sans-serif; text-align:justify"><u>Dyah Ayu Novi Hapsari,S.Farm.,Apt</u></p>
                </td>
                <td>
                    <p><u></u></p>
                </td>
            ...
            <tr>
                <td>
                    <p style="font-size: 11pt; font-family:Arial, Helvetica, sans-serif; text-align:justify">NIP. 198511032010122003</p>
                </td>
                <td>
                    <p></p>
                </td>
