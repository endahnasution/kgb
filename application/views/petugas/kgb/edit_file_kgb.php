...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo site_url('petugas/kgb/update_kgb_file') ?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box box-primary">
                    ...
                    <?php if ($this->session->flashdata('success')) : ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="no_surat" id="no_surat" value="<?=  $kgb->sk_baru ?>" required readonly>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- sppd -->
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control <?php echo form_error('tglSurat') ? 'is-invalid' : '' ?>" type="date" name="tgl_surat" value="<?=  $kgb->tgl_sk_baru ?>"  required readonly>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                <label for="noSurat" class="col-sm-8 col-form-label">File KGB<span class="wajib"></span></label></label>
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-user-circle-o"></i></span>
                                        <input type="file" class="form-control" name="file_kgb" id="file_kgb    " value="<?=  $kgb->file_kgb ?>" >
                                    </div>
                                </div>
                            </div>
