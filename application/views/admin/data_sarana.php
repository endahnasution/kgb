											...
											<tbody>
												...
												if(isset($sarana)){
													foreach ($sarana as $row){
														...
														<a href="<?=site_url('admin/master/editSarana/'. $row->idSarana)?>" class="btn btn-success btn-sm" data-tooltip="tooltip" title="Edit"  id="editSar"
														...
														data-toggle="modal" data-target="" ><i class="fa fa-edit"></i></a>
