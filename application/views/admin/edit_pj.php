  ...
  array_push($biaya, $row->biaya);
            ...
            <div class="col-md-6">
              ...
              <div class="form-group row">
               ...
               <div class="form-group">
                                <label>Nomor SPM (Diisi Oleh Keuangan)</label></label>
                                <input type="text" class="form-control" placeholder="Nomor SPM" name="spm" id="spm" value="<?= $spm ?>">
                            </div>
                      ...
                      <tr>
                        ...
                        for($i = 0; $i<count($uraian);$i++){
                          ...
                          <tr class="line_items"> 
                              ...
                              <option value="rep">Representasi</option>
                              <option value="tr">Transport</option>
                              <option value="trans">Transportasi Lokal</option>
