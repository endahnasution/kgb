...
<div class="row">
<div class="col-md-12">
    <form role="form" action="<?php echo base_url('admin/feedback/ubahFeedback')?>" enctype="multipart/form-data" method="post">
...
<div class="form-group">
            ...
            <div class="col-sm-12">
                ...
                <select class="form-control category" name="idTl" id="idTl" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12">
                    ...
                    <input type="text" name="noFeedback" id="noFeedback"  placeholder="Nomor Surat Feedback" value="<?=$row->noFeedback?>" class="form-control name_list" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12"> 
                <input class="form-control" type="date" name ="tglFeedback" id="tglFeedback"  value="<?=$row->tglFeedback?>" placeholder="Tanggal" required>
            </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12">
                    <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-building"></i></span>
                    <input type="text" name="isiFeedback" id="isiFeedback"  placeholder="Perihal Surat Feedback" value="<?=$row->isiFeedback?>" class="form-control name_list" />
                    </div>
                </div>
            </div>

            <div class="form-group row">
                <label for="noSurat" class="col-sm-4 col-form-label">Status CAPA<span class="wajib"> *</span></label>
                <div class="col-sm-12">
                <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-list"></i></span>
                <select class="form-control category" name="status" id="status" required>
                <?php if(isset($row->statusCapa)){
                    ?>
                <option value="<?=$row->statusCapa?>" selected><?=$row->statusCapa?></option>
