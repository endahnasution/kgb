<section class="content-header">
  <h1>
    Buat Surat Tugas untuk Penindakan
  </h1>
  <ol class="breadcrumb">
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <form role="form" action="<?php echo base_url('admin/surat_tugas/surat_tugas/simpan_surat_penindakan') ?>" method="post">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Form Pembuatan Surat Tugas Untuk Penindakan</h3>
              ...
              <div class="col-sm-12">
                <div class="input-group">
                  ...
                  <select class="form-control" name="kota" id="kota" required>
                    ...
                    <option>Kota Bogor, Jawa Barat</option>
                  </select>
                </div>
              </div>
            </div>
                ...
                <div class="input-group">
                  ...
                  <select class="form-control category" name="idAnggaran" id="idAnggaran" required>
                    ...
                    foreach ($anggaran as $anggaran) {
                      echo "<option value=" . $anggaran->idAnggaran . ">" . $anggaran->mak . "</option>";
                    }
                    ?>
