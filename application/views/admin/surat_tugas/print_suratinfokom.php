...
<body onload="window.print()">
		...
		<table style="width:100%">
			...
			<span style="font-size:12pt;">
				...
				<tr>
					...
					<td valign="top" style="width:80%">
						<p style="font-family:bookman old style;text-align:justify"> Undang-undang Republik Indonesia No. 18 Tahun 2012 tentang Pangan;</p>
					</td>
				</tr>
				...
				<tr>
					...
					<td valign="top" style="width:80%">
						<p style="font-family:bookman old style;text-align:justify"> Peraturan Pemerintah Republik Indonesia No. 69 Tahun 1999 tentang Label dan Iklan Pangan;</p>
					</td>
				</tr>
				...
				<tr>
					...
					<td valign="top" style="width:80%">
						<p style="font-family:bookman old style;text-align:justify"> Peraturan Pemerintah Republik Indonesia No. 86 Tahun 2019 tentang Keamanan Pangan;</p>
					</td>
				</tr>
		...
		<table style="width:100%">
			...
			<span style="font-size:12pt;">
				...
				<tr>
					...
					<td valign="top" style="width:80%">
						<p style="font-family:bookman old style;text-align:justify">Waktu<u class="hilang">iiiiiiiiiii</u>: <?php echo  convertDay($tgl_mulai) . " " . convertMonthB(convertMonthA($tgl_mulai)) . " " . convertYear($tgl_mulai) ?> s.d <?php echo convertDay($tgl_selesai) . " " . convertMonthB(convertMonthA($tgl_selesai)) . " " . convertYear($tgl_selesai) ?></p>
					</td>
				</tr>
				...
				<tr>
					...
					<td valign="top" style="width:80%">
						<p style="font-family:bookman old style;text-align:justify">Biaya<u class="hilang">iiiiiiiiiiiii</u>: DIPA Balai POM di Batam Tahun Anggaran 2022</p>
					</td>
				</tr>
	...
	<br />
	<p style="font-family:bookman old style;"> Agar yang bersangkutan melaksanakan tugas dengan baik dan penuh tanggungjawab. </p>
	...
	<p style="line-height: 1px;font-size:12pt;" align="center" style="font-family:bookman old style;"><b>Petugas Balai POM di Batam Tidak Menerima Gratifikasi Dalam Bentuk Apapun</b>
			<br />
			<b>Laporkan Pelanggaran Petugas Melalui Layanan Lapor BPOM di bit.ly/laporbpombatam</b>
			<br />
