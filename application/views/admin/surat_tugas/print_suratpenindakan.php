		...
		<table style="width:100%">
			...
			<span style="font-size:11pt;">
				...
				<tr>
					...
					<td valign="top" style="width:80%">
						<p style="font-family:bookman old style;text-align:justify"> Undang-undang Republik Indonesia No. 18 Tahun 2021 tentang Pangan;</p>
					</td>
				</tr>
		...
		<table style="width:100%">
			...
			<span style="font-size:11pt;">
				...
				<tr>
					...
					<td valign="top" style="width:80%">
						<p style="font-family:bookman old style;text-align:justify">Biaya<u class="hilang">iiiiiiiiiiiii</u>: DIPA Balai Pengawas Obat dan Makanan di Batam Tahun 2022 <br>MAK. <?php echo $mak; ?></p>
					</td>
				</tr>
