<section class="content-header">
  <h1>
    List Pengajuan KGB Yang Telah Selesai
  </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <h3 class="box-title">List Pengajuan KGB </h3>
                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    <table id="tbl" class="table table-bordered table-striped">
                      <thead>
                        <tr>
                          <th class="dt-center">No SK </th>
                          <th class="dt-center">Tgl Surat </th>
                          <th class="dt-center">Nama Pegawai</th>
                          <th class="dt-center">Tanggal Berlaku </th>
