...
class List_lhk_c extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['list_lhk'] = $this->Lhk_model->getLhkInfokom();
    $this->template->load('layouts/petugas_template', 'petugas/lhkInfokom/list_lhk_v', $data);
  }

   public function tambahLhk()
    {
        $data = konfigurasi('Pilih Surat Tugas', 'ap');
        $data['surat_tugas'] = $this->Lhk_model->getSuratTugasInfokom();
        $data['sarana'] = $this->Lhk_model->getSarana();
        $this->template->load('layouts/petugas_template', 'petugas/lhkInfokom/lhk_infokom_v', $data);
    }
    ...
    public function hapus_lhk()
    {
        ...
        redirect('petugas/lhkInfokom/list_lhk_c');
    }
  ...
  public function add()
  {
    ...
    if ($checkvalidation == true) {
      ...
      redirect('petugas/lhkInfokom/list_lhk_c', 'refresh');
    } else {
      redirect('petugas/lhkInfokom/list_lhk_c/tambahLhk', 'refresh');
    }
  }
  ...
  public function print_lhk()
  {
    ...
    $data['pejabat'] = $pejabat;
      ...
      $this->load->view('petugas/lhkInfokom/lhk_infokom_isi', $data, FALSE);
...
$data = konfigurasi('Pilih Surat Tugas', 'ap');
        ...
        $this->template->load('layouts/petugas_template', 'petugas/lhkInfokom/edit_lhk_infokom_v', $data);
    }
