...
class List_lhk_c extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['list_lhk'] = $this->Lhk_model->getLhkTu();
    $this->template->load('layouts/petugas_template', 'petugas/lhkTu/list_lhk_v', $data);
  }

   public function tambahLhk()
    {
        $data = konfigurasi('Pilih Surat Tugas', 'ap');
        $data['surat_tugas'] = $this->Lhk_model->getSuratTugasTu();
        $data['sarana'] = $this->Lhk_model->getSarana();
        $this->template->load('layouts/petugas_template', 'petugas/lhkTu/lhk_tu_v', $data);
    }
    ...
    public function hapus_lhk()
    {
        ...
        redirect('petugas/lhkTu/list_lhk_c');
    }
...
$data = konfigurasi('Pilih Surat Tugas', 'ap');
    ...
    if ($checkvalidation == true) {
      ...
      redirect('petugas/lhkTu/list_lhk_c', 'refresh');
    } else {
      redirect('petugas/lhkTu/list_lhk_c/tambahLhk', 'refresh');
    }
  }
  ...
  public function print_lhk()
  {
    ...
    $data['pejabat'] = $pejabat;
      ...
      $this->load->view('petugas/lhkTu/lhk_tu_isi', $data, FALSE);
   ...
   public function edit_lhk()
    {
        ...
        $this->template->load('layouts/petugas_template', 'petugas/lhkTu/edit_lhk_tu_v', $data);
    }
