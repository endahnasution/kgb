...
class Surat_tugas extends CI_Controller
{
      ...
      public function surat_tugas_pengujian()
    {
        ...
        $data['anggaran'] = $this->SuratTugas_model->getanggaran();
        // $data['petugas'] = $this->SuratTugas_model->getpetugasA();
        $this->template->load('layouts/admin_template', 'admin/surat_tugas/surat_tugas_pengujian', $data);
    }
     ...
     public function surat_tugas_penindakan()
    {
        ...
        // $data['petugas'] = $this->SuratTugas_model->getpetugasA();
        $this->template->load('layouts/admin_template', 'admin/surat_tugas/surat_tugas_penindakan', $data);
    }
      ...
      public function surat_tugas_tu()
    {
        ...
        $data['anggaran'] = $this->SuratTugas_model->getanggaran();
        // $data['petugas'] = $this->SuratTugas_model->getpetugasA();
        $this->template->load('layouts/admin_template', 'admin/surat_tugas/surat_tugas_tu', $data);
    }
    ...
    public function surat_tugas_infokom()
    {
        ...
        $data['anggaran'] = $this->SuratTugas_model->getanggaran();
        // $data['petugas'] = $this->SuratTugas_model->getpetugasA();
        $this->template->load('layouts/admin_template', 'admin/surat_tugas/surat_tugas_infokom', $data);
    }
     ...
     public function edit_surat_penindakan()
    {
        ...
        $data['petugas'] = $this->SuratTugas_model->getpetugas();
        $data['anggaran'] = $this->SuratTugas_model->getanggaranpenindakan();
        $this->template->load('layouts/admin_template', 'admin/surat_tugas/edit_penindakan', $data);
    }
    ...
    public function edit_surat_tu()
    {
        ...
        $data['petugas'] = $this->SuratTugas_model->getpetugas();
        $data['anggaran'] = $this->SuratTugas_model->getanggaran();
        $this->template->load('layouts/admin_template', 'admin/surat_tugas/edit_tu', $data);
    }
    ...
    public function edit_surat_infokom()
    {
        ...
        $data['petugas'] = $this->SuratTugas_model->getpetugas();
        $data['anggaran'] = $this->SuratTugas_model->getanggaraninfokom();
        $this->template->load('layouts/admin_template', 'admin/surat_tugas/edit_infokom', $data);
    }
    ...
    public function edit_surat_pengujian()
    {
        ...
        $data['petugas'] = $this->SuratTugas_model->getpetugas();
        $data['anggaran'] = $this->SuratTugas_model->getanggaranpengujian();
        $this->template->load('layouts/admin_template', 'admin/surat_tugas/edit_pengujian', $data);
    }
     ...
     public function simpan_surat_penindakan()
    {
        ...
        $this->db->insert('tbl_surattugas', $data);
        $this->session->set_flashdata('success', 'Data Berhasil Dimasukan');
        redirect('admin/surat_tugas/surat_tugas/surat_tugas_penindakan', 'refresh');
    }
     ...
     public function simpan_surat_pengujian()
    {
        ...
        $this->db->insert('tbl_surattugas', $data);
        $this->session->set_flashdata('success', 'Data Berhasil Dimasukan');
        redirect('admin/surat_tugas/surat_tugas/surat_tugas_pengujian', 'refresh');
    }
        ...
        public function simpan_surat_tu()
    {
        ...
        $this->db->insert('tbl_surattugas', $data);
        $this->session->set_flashdata('success', 'Data Berhasil Dimasukan');
        redirect('admin/surat_tugas/surat_tugas/surat_tugas_tu', 'refresh');
    }
    ...
    public function simpan_surat_infokom()
    {
        ...
        $this->db->insert('tbl_surattugas', $data);
        $this->session->set_flashdata('success', 'Data Berhasil Dimasukan');
        redirect('admin/surat_tugas/surat_tugas/surat_tugas_infokom', 'refresh');
    }
    ...
    public function ubah_surat_pengujian()
    {
        ...
        redirect('admin/surat_tugas/surat_tugas/surat_tugas_pengujian');
    }
    ...
    public function ubah_surat_penindakan()
    {
        ...
        redirect('admin/surat_tugas/surat_tugas/surat_tugas_penindakan');
    }
        ...
        public function ubah_surat_tu()
    {
        ...
        redirect('admin/surat_tugas/surat_tugas/surat_tugas_tu');
    }
        ...
        public function ubah_surat_infokom()
    {
        ...
        redirect('admin/surat_tugas/surat_tugas/surat_tugas_infokom');
    }
